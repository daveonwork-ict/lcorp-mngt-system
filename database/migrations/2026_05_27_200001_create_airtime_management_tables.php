...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('airtime_providers')) {
        ...
        if (! Schema::hasTable('airtime_wallets')) {
        ...
        if (! Schema::hasTable('airtime_wallet_ledgers')) {
        ...
        if (! Schema::hasTable('airtime_wallet_fundings')) {
        ...
        if (! Schema::hasTable('airtime_transactions')) {
            Schema::create('airtime_transactions', function (Blueprint $table): void {
                ...
                $table->index(['branch_id', 'provider_id', 'customer_mobile_number'], 'air_txn_branch_provider_mobile_idx');
                $table->index(['transaction_status', 'processed_at']);
            });
        }

        if (! Schema::hasTable('airtime_commissions')) {
        ...
        if (! Schema::hasTable('airtime_wallet_adjustments')) {
        ...
        if (! Schema::hasTable('airtime_alerts')) {
