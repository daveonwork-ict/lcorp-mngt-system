...
return new class extends Migration
{
    ...
    {
        Schema::create('cash_openings', function (Blueprint $table): void {
            $table->id();
            ...
            $table->index(['branch_id', 'cashier_id', 'opening_date']);
            $table->index(['status', 'opening_date']);
        });

        Schema::create('cash_ins', function (Blueprint $table): void {
            $table->id();
