...
@section('page_title', 'Go-Live Checklist')
@section('content')
<div class="card">
    <div class="table-responsive p-0">
        <table class="table table-sm mb-0">
            <thead><tr><th>Item</th><th>Status</th><th>Remarks</th><th>Branch</th><th>Checked By</th><th>Checked At</th><th></th></tr></thead>
            <tbody>
            @foreach($items as $item)
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('deployment.go-live.update', $item) }}" class="d-flex flex-wrap gap-2">@csrf @method('PUT')
