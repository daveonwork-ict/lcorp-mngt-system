...
class StoreAttendanceLogRequest extends FormRequest
{
    ...
    {
        $gpsRequired = (bool) env('RMS_HR_ATTENDANCE_REQUIRE_GPS', false);
        ...
        return [
            ...
            'selfie_time_in' => ['required', 'image', 'mimes:jpg,jpeg,png,webp', 'max:4096'],
            'selfie_time_out' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:4096'],
            'gps_latitude_in' => [$gpsRequired ? 'required' : 'nullable', 'numeric', 'between:-90,90'],
            'gps_longitude_in' => [$gpsRequired ? 'required' : 'nullable', 'numeric', 'between:-180,180'],
