...
class AirtimeWalletLedgerController extends Controller
{
    ...
    {
        return view('airtime.ledgers.index', [
            'ledgers' => $this->reportService->ledgers($request->only(['date_from', 'date_to', 'branch_id', 'provider_id'])),
